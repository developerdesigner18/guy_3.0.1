    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="main_navbar">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="<?= url('#pricing') ?>"> <?= $this->language->global->menu->pricing ?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?= url('help') ?>"> <?= $this->language->help->menu ?></a></li>
