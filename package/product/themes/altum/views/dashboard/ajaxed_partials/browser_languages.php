...
<div class="animate__animated animate__fadeIn">
    <div class="d-flex justify-content-between mb-2">
        <small class="text-muted font-weight-bold text-uppercase"><?= $this->language->dashboard->browser_languages->language ?></small>
    ...
    <?php else: ?>
        ...
        <?php if($data->total_rows > count($data->rows)): ?>
            <a href="<?= url('dashboard/browser_languages') ?>"><?= sprintf($this->language->global->view_x_more, nr($data->total_rows - count($data->rows))) ?></a>
        <?php endif ?>
