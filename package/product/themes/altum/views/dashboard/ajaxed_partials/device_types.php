...
<div class="animate__animated animate__fadeIn">
    <div class="d-flex justify-content-between mb-2">
        <small class="text-muted font-weight-bold text-uppercase"><?= $this->language->dashboard->device_types->device_type ?></small>
    ...
    <?php else: ?>
        ...
        <?php foreach($data->rows as $row): ?>
            ...
            <div class="mb-3">
                <div class="d-flex justify-content-between mb-1">
                    <div>
                        <span><i class="fa fa-fw fa-<?= $row->device_type ?> fa-sm mr-1"></i> <?= $this->language->visitor->device_type->{$row->device_type} ?></span>
                    </div>
        ...
        <?php if($data->total_rows > count($data->rows)): ?>
            <a href="<?= url('dashboard/device_types') ?>"><?= sprintf($this->language->global->view_x_more, nr($data->total_rows - count($data->rows))) ?></a>
        <?php endif ?>
