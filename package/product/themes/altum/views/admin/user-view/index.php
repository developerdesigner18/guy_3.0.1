...
<div class="my-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-server mr-1"></i> <?= $this->language->admin_user_view->websites ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_websites_total) ?></span></div>
            </div>

            <div class="bg-gray-200 px-2 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/websites?email=' . $data->user->email) ?>">
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-user-shield mr-1"></i> <?= $this->language->admin_user_view->teams ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_teams_total) ?></span></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-user mr-1"></i> <?= $this->language->admin_user_view->teams_associations ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->user_teams_associations_total) ?></span></div>
            </div>
        </div>
    </div>
</div>
