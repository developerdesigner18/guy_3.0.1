        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title">
                    ...
                    <?= $this->language->admin_website_delete_modal->header ?>
                </h5>
            ...
            <div class="modal-body">
                <p class="text-muted"><?= $this->language->admin_website_delete_modal->subheader ?></p>

                <div class="mt-4">
                    <a href="" id="website_delete_url" class="btn btn-lg btn-block btn-danger"><?= $this->language->global->delete ?></a>
                </div>
            </div>
