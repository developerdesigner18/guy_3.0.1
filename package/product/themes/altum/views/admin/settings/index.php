...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" href="#analytics" data-toggle="pill" role="tab"><i class="fa fa-fw fa-sm fa-chart-pie mr-1"></i> <?= $this->language->admin_settings->tab->analytics ?></a>
                ...
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="analytics">
                            <div class="form-group">
                                <label><i class="fa fa-fw fa-sm fa-video text-muted mr-1"></i> <?= $this->language->admin_settings->analytics->sessions_replays_is_enabled ?></label>

                                <select name="analytics_sessions_replays_is_enabled" class="form-control form-control-lg">
                                    <option value="1" <?= $this->settings->analytics->sessions_replays_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->analytics->sessions_replays_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                </select>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->sessions_replays_is_enabled_help ?></small><br />
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->sessions_replays_is_enabled_help2 ?></small><br />
                                <small class="form-text text-muted"><?= sprintf($this->language->admin_settings->analytics->sessions_replays_is_enabled_help3, ini_get('post_max_size')) ?></small>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->analytics->sessions_replays_minimum_duration ?></label>
                                <input type="number" min="1" name="analytics_sessions_replays_minimum_duration" class="form-control form-control-lg" value="<?= $this->settings->analytics->sessions_replays_minimum_duration ?>" />
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->sessions_replays_minimum_duration_help ?></small><br />
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->sessions_replays_minimum_duration_help2 ?></small>
                            </div>

                            <div class="form-group">
                                <label><i class="fa fa-fw fa-sm fa-fire text-muted mr-1"></i> <?= $this->language->admin_settings->analytics->websites_heatmaps_is_enabled ?></label>

                                <select name="analytics_websites_heatmaps_is_enabled" class="form-control form-control-lg">
                                    <option value="1" <?= $this->settings->analytics->websites_heatmaps_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->yes ?></option>
                                    <option value="0" <?= !$this->settings->analytics->websites_heatmaps_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->no ?></option>
                                </select>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->websites_heatmaps_is_enabled_help ?></small><br />
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->analytics->pixel_cache ?></label>
                                <input type="number" min="0" name="analytics_pixel_cache" class="form-control form-control-lg" value="<?= $this->settings->analytics->pixel_cache ?>" />
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->pixel_cache_help ?></small>
                            </div>

                            <div class="form-group">
                                <label><?= $this->language->admin_settings->analytics->pixel_exposed_identifier ?></label>
                                <input type="text" name="analytics_pixel_exposed_identifier" class="form-control form-control-lg" value="<?= $this->settings->analytics->pixel_exposed_identifier ?>" />
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->pixel_exposed_identifier_help ?></small>
                            </div>

                            <div class="form-group">
                                <label><i class="fa fa-fw fa-sm fa-fire text-muted mr-1"></i> <?= $this->language->admin_settings->analytics->email_reports_is_enabled ?></label>

                                <select name="analytics_email_reports_is_enabled" class="form-control form-control-lg">
                                    <option value="0" <?= !$this->settings->analytics->email_reports_is_enabled ? 'selected="selected"' : null ?>><?= $this->language->global->disabled ?></option>
                                    <option value="weekly" <?= $this->settings->analytics->email_reports_is_enabled == 'weekly' ? 'selected="selected"' : null ?>><?= $this->language->admin_settings->analytics->email_reports_is_enabled_weekly ?></option>
                                    <option value="monthly" <?= $this->settings->analytics->email_reports_is_enabled == 'monthly' ? 'selected="selected"' : null ?>><?= $this->language->admin_settings->analytics->email_reports_is_enabled_monthly ?></option>
                                </select>
                                <small class="form-text text-muted"><?= $this->language->admin_settings->analytics->email_reports_is_enabled_help ?></small><br />
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="cron">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg disabled" value="<?= $this->settings->cron->reset_date ?>" disabled="disabled" />
                            </div>
                        </div>
