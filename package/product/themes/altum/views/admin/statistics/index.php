...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills">
            ...
            <?php endif ?>
            <a class="nav-link <?= $data->type == 'analytics' ? 'active' : null ?>" href="<?= url('admin/statistics/analytics?start_date=' . $data->date->start_date . '&end_date=' . $data->date->end_date) ?>"><i class="fa fa-fw fa-sm fa-chart-pie mr-1"></i> <?= $this->language->admin_statistics->analytics->menu ?></a>
