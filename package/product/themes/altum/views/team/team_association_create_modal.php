    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title"><?= $this->language->team_association_create_modal->header ?></h5>
            ...
            <div class="modal-body">
                <form name="team_association_create" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label><i class="fa fa-fw fa-sm fa-envelope text-muted mr-1"></i> <?= $this->language->team_association_create_modal->input->email ?></label>
