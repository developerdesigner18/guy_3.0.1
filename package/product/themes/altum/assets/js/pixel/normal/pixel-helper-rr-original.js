    ...
    ***************************************************************************** */
    ...
    function isBlocked(node, blockClass) {
        ...
        if (node.nodeType === node.ELEMENT_NODE) {
            ...
            /* ALTUMCODE MOD */
            if(blocked_input_types.includes(node.type)) {
                return true;
            }

            if(node.name && blocked_input_names_or_ids.includes(node.name)) {
                return true;
            }

            if(node.id && blocked_input_names_or_ids.includes(node.id)) {
                return true;
            }
            /* END ALTUMCODE MOD */
