/* Rrweb record 0.8.5 library modded for using the replayer */
    ...
    ***************************************************************************** */
    ...
    var Replayer = (function () {
        ...
        Replayer.prototype.setupDom = function () {
            ...
            this.config.root.appendChild(this.iframe);
        ...
        Replayer.prototype.handleResize = function (dimension) {
            ...
            // document.querySelector('#snapshot').setAttribute('style', `width: ${dimension.width}px; height: ${dimension.height}px;`);
        };
