...
class AdminSettings extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            /* Analytics Tab */
            $_POST['analytics_sessions_replays_is_enabled'] = (bool) $_POST['analytics_sessions_replays_is_enabled'];
            $_POST['analytics_sessions_replays_minimum_duration'] = (int) $_POST['analytics_sessions_replays_minimum_duration'];
            $_POST['analytics_websites_heatmaps_is_enabled'] = (bool) $_POST['analytics_websites_heatmaps_is_enabled'];
            $_POST['analytics_pixel_cache'] = (int) $_POST['analytics_pixel_cache'];
            $_POST['analytics_pixel_exposed_identifier'] = trim(get_slug($_POST['analytics_pixel_exposed_identifier']));
            $_POST['analytics_email_reports_is_enabled'] = in_array($_POST['analytics_sessions_replays_is_enabled'], [0, 'weekly', 'monthly']) ? $_POST['analytics_email_reports_is_enabled'] : 0;
            ...
            if(empty($_SESSION['error'])) {
                ...
                $settings_keys = [
                    ...
                    'analytics' => [
                        ...
                        'sessions_replays_minimum_duration',
                        'websites_heatmaps_is_enabled',
                        'pixel_cache',
                        'pixel_exposed_identifier',
                ...
                foreach($settings_keys as $key => $value) {
                    ...
                    if(is_array($value)) {
                        ...
                        foreach($value as $sub_key) {
                            ...
                            if(!in_array($key . '_' . $sub_key, ['custom_head_css', 'custom_head_js', 'ads_header', 'ads_footer', 'offline_payment_instructions'])) {
