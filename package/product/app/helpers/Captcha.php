...
class Captcha {
    ...
    public function display() {
        ...
        if($this->recaptcha && $this->recaptcha_public_key && $this->recaptcha_private_key) {
            ...
            echo '<img src="' . $this->captcha_location . '" class="mb-2" id="captcha" alt="' . Language::get()->global->accessibility->captcha_alt . '" /><input type="text" name="captcha" class="form-control form-control-lg" placeholder="' . Language::get()->global->captcha_placeholder . '" aria-label="' . Language::get()->global->accessibility->captcha_input . '" required="required" autocomplete="off" />';
        }
